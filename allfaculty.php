...
if (array_key_exists("search", $_POST)) {
    ...
    $query = "SELECT id,First_Name,Last_Name,Religion,Gender, Date_of_birth,County,Address,Joining_Date,Designation,Status,Father_Name,
                    Father_Mobile_No,Father_Profession FROM faculty WHERE First_Name='$firstname'|| Middle_Name='$middlename'||Last_Name='$lastname'
                     ORDER BY Class asc";
    $result = @mysqli_query($link, $query);
}else{
    $query = "SELECT id,First_Name,Last_Name,Religion,Gender, Date_of_birth,County,Address,Joining_Date,Designation,Status,Father_Name,
                Father_Mobile_No,Father_Profession FROM faculty ORDER BY Class DESC ";
    $result = @mysqli_query($link, $query);
...
<div class="container">
    <form action="" method="post">
        <span class="heading">Enter Employee Details To Search</span>
