...
include ('header.php');
$count ="0";
$query = "SELECT id,First_Name,Last_Name,Religion,Gender, Date_of_birth,Phone_No,County,Address,Joining_Date,Designation,Status,Father_Name,Father_Mobile_No,Father_Profession FROM faculty WHERE Status='active';";
...
?>
<div id="table">
    <span class="results">All Active Employees Information</span>
    ...
    ?>
        <div style="height: 40px; font-size: 20px" class="progress" >
            ...
            aria-valuemax="100">Total Active Employees<?php echo $count;?>
