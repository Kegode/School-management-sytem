...
if (array_key_exists("updatestudentinfo", $_POST))
{
    ...
    $query = "UPDATE faculty SET 'First_Name','Last_Name','Religion','Gender', 'Date_of_birth','County','Address','Joining_Date','''Designation''Status','Father_Name','Father_Mobile_No','Father_Profession')
