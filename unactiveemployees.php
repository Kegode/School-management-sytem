...
include ('header.php');
$count ="0";
$query = "SELECT id,First_Name,Last_Name,Religion,Gender, Date_of_birth,Phone_No,County,Address,Joining_Date,Designation,Status,Father_Name,Father_Mobile_No,Father_Profession FROM faculty WHERE Status='un-active';";
...
<head>
    ...
    <title>Un-Active Employees</title>
    <style type="text/css">
        body{
            margin-bottom: 60px;
        }
...
?>
<div id="table">
    <span class="results">All Un-Active Employees Information</span>
    <table class="table table-striped table-dark">
        ...
        <div style="height: 40px; font-size: 20px" class="progress" >
            <div class="progress-bar progress-bar-striped progress-bar-animated" role="progressbar" style="width: 100%;"aria-valuenow="25"aria-valuemin="0"
                 aria-valuemax="100">Total Un-Active Employees<?php echo $count;?>
