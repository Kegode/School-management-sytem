...
include ('header.php');
$query = "SELECT id,First_Name,Last_Name,Religion,Gender, Date_of_birth,Phone_No,County,Address,Joining_Date,Designation,Status,Father_Name,Father_Mobile_No,Father_Profession FROM 'students';";
...
<div id="table">
    ...
    <table class="table table-striped table-dark">
        ...
        <tr class='<?php if(isset($classname)) echo $classname;?>'>
            ...
            <td><a href='edit-process.php?id=<?php echo $row['id'];?>'>Update</a></td>
        </tr>;
    </table>
    <?php
    }
