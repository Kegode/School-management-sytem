...
if (array_key_exists("submitstudentinfo", $_POST))
{
    ...
    $query = "INSERT INTO 'faculty'('First_Name','Last_Name','Religion','Gender', 'Date_of_birth','Phone_No','County','Address','Joining_Date','''Designation''Status','Father_Name','Father_Mobile_No','Father_Profession')
    ...
    <form action="" method="post">
        ...
        <div id="student" class="information">
            ...
            <div class="form-group col-md-6">
                ...
                <input type="number" name="phonenumber" required class="form-control" id="phonenumber" placeholder="Telephone No.">
            </div>
            <div class="form-group col-md-6">
            ...
            <div class="form-group col-md-6">
                ...
                <input  type="text" name="designation" required class="form-control" id="designation" placeholder="Designation">
            </div>
            <div class="form-group col-md-6">
